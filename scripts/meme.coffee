...
#   hubot <text> you're gonna have a bad time
#     Super Cool Ski Instructor from South Park
...
#   hubot <text> nobody bats an eye <text> everyone loses their minds
...
#     msg.reply 'To use your own Imgflip account,
