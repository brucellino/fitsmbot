...
#
# Commands:
#   hubot give <number> points to <username>
# - award <number> points to <username>
#   hubot give <username> <number> points
# - award <number> points to <username>
#   hubot take <number> points from <username>
# - take away <number> points from <username>
#   hubot how many points does <username> have?
# - list how many points <username> has
